                ...
                if (empty($error)) {
                    try {
                        ...
                        if ($stmt->execute()) {
                            ...
                            $deskripsi_text = "Menambahkan data kelas: $nama_kelas";
                ...
                if (empty($error)) {
                    try {
                        ...
                        if ($stmt->execute()) {
                            ...
                            $ip_address = $_SERVER['REMOTE_ADDR'] ?? 'unknown';
                            $user_agent = substr($_SERVER['HTTP_USER_AGENT'] ?? 'unknown', 0, 500);
                            $deskripsi_text = "Memperbarui data kelas: $nama_kelas";
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalKelas">
