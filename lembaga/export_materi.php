...
// Ambil data dengan JOIN ke tabel kelas jika kelas_id ada (case-insensitive sorting)
if ($has_kelas_id) {
...
if ($format == 'excel') {
    ...
    echo "<table border='1'>";
    echo "<tr><th>No</th><th>$label_kategori</th><th>Nama Mulok</th><th>Kelas</th></tr>";
    $no = 1;
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . htmlspecialchars($has_kelas_id ? ($row['nama_kelas'] ?? '-') : '-') . "</td>";
        echo "</tr>";
    }
    echo "</table>";
} else {
